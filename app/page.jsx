  ...
  return (
    <div className="min-h-screen p-4 md:p-8 pb-24 max-w-5xl mx-auto">
        ...
        <div className="mb-8">
            ...
            <div className="flex justify-between items-center bg-white dark:bg-[#1a103c] p-4 rounded-lg border border-gray-200 dark:border-purple-900/30 shadow-sm">
                ...
                <button className="px-4 py-2 border border-purple-500 text-purple-600 dark:text-purple-400 rounded hover:bg-purple-50 dark:hover:bg-purple-900/50 transition-colors text-sm font-medium">
                    &lt; Previous
                </button>
            </div>
        </div>
        ...
        <section className="bg-white dark:bg-[#1a103c] p-6 md:p-8 rounded-2xl border-l-4 border-pink-500 shadow-lg mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Linear Regression is one of the most fundamental and widely used techniques in the field of machine learning and statistics. It models the relationship between a <span className="text-blue-500 dark:text-blue-400 font-bold">dependent variable</span> (often denoted as Y) and one or more <span className="text-purple-600 dark:text-purple-400 font-bold">independent variables</span> (X).
            </p>
        ...
        <section className="bg-white dark:bg-[#1a103c] p-6 md:p-8 rounded-2xl border-l-4 border-purple-500 shadow-lg mb-8">
            ...
            <div className="flex justify-center bg-gray-50 dark:bg-[#0f0a1e] p-8 rounded-xl mb-6 border border-gray-200 dark:border-gray-800">
                <code className="text-2xl md:text-3xl font-mono text-gray-800 dark:text-white tracking-wider">Y = β₀ + β₁X + ε</code>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-lg">
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-600 dark:text-gray-300 text-sm">
                    <li><span className="text-pink-500 font-bold">Y</span> : Dependent variable (Target)</li>
                    <li><span className="text-purple-500 font-bold">X</span> : Independent variable (Feature)</li>
                    <li><span className="text-blue-500 font-bold">β₀</span> : Y-Intercept (value of Y when X=0)</li>
                    <li><span className="text-blue-500 font-bold">β₁</span> : Slope (how much Y changes with X)</li>
                </ul>
            </div>
        </section>
        ...
        {/* Section 7: Interactive Graph Component */}
        {/* This requires that you have the file components/InteractiveGraph.jsx */}
        <InteractiveGraph />

        {/* Footer Navigation */}
        <div className="sticky bottom-4 bg-white/90 dark:bg-[#0f0a1e]/95 backdrop-blur p-4 border border-gray-200 dark:border-gray-800 mt-12 flex justify-between items-center rounded-xl shadow-2xl z-40">
            <div>
